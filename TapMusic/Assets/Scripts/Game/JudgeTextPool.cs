...
public class JudgeTextPool : MonoBehaviour
{
    #region Singleton
    public static JudgeTextPool Instance { get; private set; }
    ...
    private void Initialize()
    {
        pool = new ObjectPool<GameObject>(
            ...
            defaultCapacity: textInitNum,               //初期のプールサイズ
            maxSize: textMax                            //最大プールサイズ
            );

        posY = textPrefab.transform.localPosition.y;
    }
    #endregion
